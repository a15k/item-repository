...
public class InlineResponse2002 {
  ...
  **/
  ...
  public InlineResponse2002 data(List<Format> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(Format dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Format>();
    }
