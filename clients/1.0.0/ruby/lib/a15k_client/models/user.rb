...
module A15kClient
  ...
  class User
    ...
    def valid?
      ...
      role_validator = EnumAttributeValidator.new('String', ["power_user", "standard_user"])
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["power_user", "standard_user"])
