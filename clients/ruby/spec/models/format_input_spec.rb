...
# Unit tests for A15kClient::FormatInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FormatInput' do
  before do
    # run before each test
    @instance = A15kClient::FormatInput.new
  end
  ...
  describe 'test an instance of FormatInput' do
    it 'should create an instance of FormatInput' do
      expect(@instance).to be_instance_of(A15kClient::FormatInput)
    end
  end
