...
public class InlineResponse2005 {
  ...
  @SerializedName("data")
  private List<AccessToken> data = null;
  ...
  **/
  ...
  public InlineResponse2005 data(List<AccessToken> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2005 addDataItem(AccessToken dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<AccessToken>();
    }
