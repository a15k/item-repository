...
# Unit tests for A15kClient::AssessmentInputQuestions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AssessmentInputQuestions' do
  before do
    # run before each test
    @instance = A15kClient::AssessmentInputQuestions.new
  end
  ...
  describe 'test an instance of AssessmentInputQuestions' do
    it 'should create an instance of AssessmentInputQuestions' do
      expect(@instance).to be_instance_of(A15kClient::AssessmentInputQuestions)
    end
  end
