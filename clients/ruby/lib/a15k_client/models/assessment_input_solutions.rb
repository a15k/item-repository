...
module A15kClient
  ...
  class AssessmentInputSolutions
    # The uuid of a previously registered format
    attr_accessor :format_id

    # Content of the solution. Formatting of the content is indicated by the linked format
    attr_accessor :content

    # A unique value shared with multiple solutions, allowing them to be linked together for auto-generated assessments
    ...
    def hash
      [format_id, content, variant].hash
    end
