...
# Unit tests for A15kClient::AssessmentInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AssessmentInput' do
  before do
    # run before each test
    @instance = A15kClient::AssessmentInput.new
  end
  ...
  describe 'test an instance of AssessmentInput' do
    it 'should create an instance of AssessmentInput' do
      expect(@instance).to be_instance_of(A15kClient::AssessmentInput)
    end
  end
