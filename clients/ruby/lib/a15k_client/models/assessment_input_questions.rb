...
module A15kClient
  ...
  class AssessmentInputQuestions
    # The uuid of a previously registered format
    attr_accessor :format_id

    # Content of the question. Formatting of the content is indicated by the linked format
    ...
    def self.swagger_types
      {
        :'format_id' => :'String',
        :'content' => :'String',
        :'solutions' => :'Array<AssessmentInputSolutions>'
      }
    end
