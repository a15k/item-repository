...
# Unit tests for A15kClient::AssessmentInputSolutions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AssessmentInputSolutions' do
  before do
    # run before each test
    @instance = A15kClient::AssessmentInputSolutions.new
  end
  ...
  describe 'test an instance of AssessmentInputSolutions' do
    it 'should create an instance of AssessmentInputSolutions' do
      expect(@instance).to be_instance_of(A15kClient::AssessmentInputSolutions)
    end
  end
